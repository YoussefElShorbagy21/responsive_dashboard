...
class InActiveAllExpenseItem extends StatelessWidget {
  const InActiveAllExpenseItem({super.key, required this.itemModel});
      ...
      child: Column(
        ...
        children: [
          AllExpenseItemHeader(
            allExpenseItemHeaderModel: itemModel,
...
class ActiveAllExpenseItem extends StatelessWidget {
  const ActiveAllExpenseItem({super.key, required this.itemModel});
